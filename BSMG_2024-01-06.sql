...
# Database: BSMG
# Generation Time: 2024-01-05 18:10:16 +0000
# ************************************************************
...
VALUES
	...
	(36,'문주영','20240103003202','SW2팀장','테스트유저,부소장,박준언이름','2024년 01월 03일 문주영이름 일일 업무보고','1. BSMG 리팩토링\n- 사용자 정보 암호화 (argon2)\n\nTODO : \n- 사용한 디자인 패턴 정리 및 \n- WeekReport 생성을 Cron을 통한 자동화\n- 코드 모듈화\n- Session -> JWT\n- DB 전달을 채널링을 통해 구현 (고민중)\n\n',1,3,'하고싶은건 많은데 그래도 차근차근 해나가야함',0),
	(37,'문주영','20240105234348','SW2팀장','테스트유저,부소장','2024년 01월 05일 문주영이름 일일 업무보고','1. BSMG 리팩토링\n- JWT 사용하여 로그인 및 인가처리 개발\n- Config.json 파일을 통해 서버 설정 제어하도록 개발\n- Cron을 이용하여 주간보고 자동화 개발\n\nTODO : \n- 사용한 디자인 패턴 정리 및 \n- 코드 모듈화\n\n\n',1,3,'',0);
...
VALUES
	(9,'부소장','20231231000000','짜투리팀장','12월 5주차 부소장 주간 업무보고','📆20231225011321\n보고 확인테스트\n\n\n수정이 되었을까요',1,'20231226, 20231227, 20231228, 20231229'),
