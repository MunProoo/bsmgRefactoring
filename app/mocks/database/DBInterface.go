...
func (_m *DBInterface) SelecAttrSearchReportList(pageInfo define.PageInfo, attrData define.AttrSearchData) ([]define.BsmgReportInfo, int32, error) {
...
func (_m *DBInterface) SelectReportInfo(idx int) (define.BsmgReportInfo, error) {
	ret := _m.Called(idx)
...
func (_m *DBInterface) SelectReportList(pageInfo define.PageInfo, searchData define.SearchData) ([]define.BsmgReportInfo, int32, error) {
...
func (_m *DBInterface) SelectWeekReportCategorySearch(pageInfo define.PageInfo, partIdx int) ([]define.BsmgWeekRptInfo, int32, error) {
...
func (_m *DBInterface) SelectWeekReportInfo(wRptIdx int) (define.BsmgWeekRptInfo, error) {
	ret := _m.Called(wRptIdx)
...
func (_m *DBInterface) SelectWeekReportList(pageInfo define.PageInfo, searchData define.SearchData) ([]define.BsmgWeekRptInfo, int32, error) {
	ret := _m.Called(pageInfo, searchData)
