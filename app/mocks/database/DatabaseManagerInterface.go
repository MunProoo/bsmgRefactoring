...
func (_m *DatabaseManagerInterface) SelecAttrSearchReportList(pageInfo define.PageInfo, attrData define.AttrSearchData) ([]define.BsmgReportInfoForWeb, int32, error) {
...
func (_m *DatabaseManagerInterface) SelectReportInfo(idx int) (define.BsmgReportInfoForWeb, error) {
	ret := _m.Called(idx)
...
func (_m *DatabaseManagerInterface) SelectReportList(pageInfo define.PageInfo, searchData define.SearchData) ([]define.BsmgReportInfoForWeb, int32, error) {
...
func (_m *DatabaseManagerInterface) SelectWeekReportCategorySearch(pageInfo define.PageInfo, partIdx int) ([]define.BsmgWeekRptInfoForWeb, int32, error) {
...
func (_m *DatabaseManagerInterface) SelectWeekReportInfo(wRptIdx int) (define.BsmgWeekRptInfoForWeb, error) {
	ret := _m.Called(wRptIdx)
...
func (_m *DatabaseManagerInterface) SelectWeekReportList(pageInfo define.PageInfo, searchData define.SearchData) ([]define.BsmgWeekRptInfoForWeb, int32, error) {
	ret := _m.Called(pageInfo, searchData)
