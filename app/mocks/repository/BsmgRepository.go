...
func (_m *BsmgRepository) CheckMemberIDDuplicate(memID string) (bool, error) {
	ret := _m.Called(memID)
...
func (_m *BsmgRepository) ConfirmRpt(rptIdx int32) error {
...
func (_m *BsmgRepository) ConnectBSMG() error {
	ret := _m.Called()
...
func (_m *BsmgRepository) ConnectMariaDB() error {
	ret := _m.Called()
...
func (_m *BsmgRepository) CreateAttr1Table() error {
	ret := _m.Called()
...
func (_m *BsmgRepository) CreateAttr2Table() error {
	ret := _m.Called()
...
func (_m *BsmgRepository) CreateDailyReportTable() error {
	ret := _m.Called()
...
func (_m *BsmgRepository) CreateDataBase() error {
	ret := _m.Called()
...
func (_m *BsmgRepository) CreateMemberTable() error {
	ret := _m.Called()
...
func (_m *BsmgRepository) CreatePartTable() error {
	ret := _m.Called()
...
func (_m *BsmgRepository) CreateRankTable() error {
	ret := _m.Called()
...
func (_m *BsmgRepository) CreateScheduleTable() error {
	ret := _m.Called()
...
func (_m *BsmgRepository) CreateWeekReportTable() error {
	ret := _m.Called()
...
func (_m *BsmgRepository) DeleteMember(memId string) error {
	ret := _m.Called(memId)
...
func (_m *BsmgRepository) DeleteReport(rptIdx int32) error {
	ret := _m.Called(rptIdx)
...
func (_m *BsmgRepository) DeleteSchedule(rptIdx int32) error {
	ret := _m.Called(rptIdx)
...
func (_m *BsmgRepository) DeleteWeekReport(wRptIdx int) error {
...
func (_m *BsmgRepository) FindMinIdx() int32 {
	ret := _m.Called()
...
func (_m *BsmgRepository) InsertDailyReport(report define.BsmgReportInfo) error {
...
func (_m *BsmgRepository) InsertSchedule(schedule define.BsmgScheduleInfo) error {
...
func (_m *BsmgRepository) InsertWeekReport(wRptInfo define.BsmgWeekRptInfo) error {
...
func (_m *BsmgRepository) IsConnected() error {
	ret := _m.Called()
...
func (_m *BsmgRepository) IsExistBSMG() error {
	ret := _m.Called()
...
func (_m *BsmgRepository) MakeAttrTree() ([]define.AttrTree, error) {
	ret := _m.Called()
...
func (_m *BsmgRepository) MakePartTree() ([]define.PartTree, error) {
	ret := _m.Called()
...
func (_m *BsmgRepository) Release() {
	_m.Called()
}

// SelecAttrSearchReportList provides a mock function with given fields: pageInfo, attrData
func (_m *BsmgRepository) SelecAttrSearchReportList(pageInfo define.PageInfo, attrData define.AttrSearchData) ([]define.BsmgReportInfo, int32, error) {
...
func (_m *BsmgRepository) SelectAttr1List() ([]define.BsmgAttr1Info, error) {
	ret := _m.Called()
...
func (_m *BsmgRepository) SelectLatestRptIdx(reporter string) (int32, error) {
...
func (_m *BsmgRepository) SelectMemberInfo(member *define.BsmgMemberInfo) error {
	ret := _m.Called(member)
...
func (_m *BsmgRepository) SelectMemberListSearch(searchData define.SearchData) ([]define.BsmgMemberInfo, error) {
...
func (_m *BsmgRepository) SelectPartLeader(Mem_Part int32) (string, error) {
...
func (_m *BsmgRepository) SelectPartist() ([]define.BsmgPartInfo, error) {
	ret := _m.Called()
...
func (_m *BsmgRepository) SelectRankList() ([]define.BsmgRankInfo, error) {
	ret := _m.Called()
...
func (_m *BsmgRepository) SelectReportInfo(idx int) (define.BsmgReportInfo, error) {
	ret := _m.Called(idx)
...
func (_m *BsmgRepository) SelectReportList(pageInfo define.PageInfo, searchData define.SearchData) ([]define.BsmgReportInfo, int32, error) {
...
func (_m *BsmgRepository) SelectReportListAWeek(Mem_ID string, bef7d string, bef1d string) ([]define.BsmgReportInfo, error) {
...
func (_m *BsmgRepository) SelectScheduleList(rptIdx int32) ([]define.BsmgScheduleInfo, error) {
	ret := _m.Called(rptIdx)
...
func (_m *BsmgRepository) SelectWeekReportCategorySearch(pageInfo define.PageInfo, partIdx int) ([]define.BsmgWeekRptInfo, int32, error) {
...
func (_m *BsmgRepository) SelectWeekReportInfo(wRptIdx int) (define.BsmgWeekRptInfo, error) {
	ret := _m.Called(wRptIdx)
...
func (_m *BsmgRepository) SelectWeekReportList(pageInfo define.PageInfo, searchData define.SearchData) ([]define.BsmgWeekRptInfo, int32, error) {
	ret := _m.Called(pageInfo, searchData)
...
func (_m *BsmgRepository) UpdateReportInfo(report define.BsmgReportInfo) error {
	ret := _m.Called(report)
...
func (_m *BsmgRepository) UpdateUser(member define.BsmgMemberInfo) error {
	ret := _m.Called(member)
...
func (_m *BsmgRepository) UpdateWeekReportInfo(report define.BsmgWeekRptInfo) error {
	ret := _m.Called(report)
...
// NewBsmgRepository creates a new instance of BsmgRepository. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewBsmgRepository(t interface {
	mock.TestingT
	Cleanup(func())
}) *BsmgRepository {
	mock := &BsmgRepository{}
