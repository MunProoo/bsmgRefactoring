...
func (_m *BsmgRepository) SelecAttrSearchReportList(pageInfo define.PageInfo, attrData define.AttrSearchData) ([]define.BsmgReportInfoForWeb, int32, error) {
...
func (_m *BsmgRepository) SelectReportInfo(idx int) (define.BsmgReportInfoForWeb, error) {
	ret := _m.Called(idx)
...
func (_m *BsmgRepository) SelectReportList(pageInfo define.PageInfo, searchData define.SearchData) ([]define.BsmgReportInfoForWeb, int32, error) {
...
func (_m *BsmgRepository) SelectWeekReportCategorySearch(pageInfo define.PageInfo, partIdx int) ([]define.BsmgWeekRptInfoForWeb, int32, error) {
...
func (_m *BsmgRepository) SelectWeekReportInfo(wRptIdx int) (define.BsmgWeekRptInfoForWeb, error) {
	ret := _m.Called(wRptIdx)
...
func (_m *BsmgRepository) SelectWeekReportList(pageInfo define.PageInfo, searchData define.SearchData) ([]define.BsmgWeekRptInfoForWeb, int32, error) {
	ret := _m.Called(pageInfo, searchData)
