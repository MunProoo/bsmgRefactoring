...
func (_m *BsmgUsecase) SelecAttrSearchReportList(pageInfo define.PageInfo, attrData define.AttrSearchData) ([]define.BsmgReportInfo, int32, error) {
...
func (_m *BsmgUsecase) SelectReportInfo(idx int) (define.BsmgReportInfo, error) {
	ret := _m.Called(idx)
...
func (_m *BsmgUsecase) SelectReportList(pageInfo define.PageInfo, searchData define.SearchData) ([]define.BsmgReportInfo, int32, error) {
...
func (_m *BsmgUsecase) SelectWeekReportCategorySearch(pageInfo define.PageInfo, partIdx int) ([]define.BsmgWeekRptInfo, int32, error) {
...
func (_m *BsmgUsecase) SelectWeekReportInfo(wRptIdx int) (define.BsmgWeekRptInfo, error) {
	ret := _m.Called(wRptIdx)
...
func (_m *BsmgUsecase) SelectWeekReportList(pageInfo define.PageInfo, searchData define.SearchData) ([]define.BsmgWeekRptInfo, int32, error) {
	ret := _m.Called(pageInfo, searchData)
...
// NewBsmgUsecase creates a new instance of BsmgUsecase. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewBsmgUsecase(t interface {
	mock.TestingT
	Cleanup(func())
}) *BsmgUsecase {
	mock := &BsmgUsecase{}
